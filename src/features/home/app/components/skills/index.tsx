            ...
            >
              {categories.map((category) => {
                ...
                return (
                  ...
                  >
                    <div className="mb-4 flex items-center justify-between text-2xs font-semibold tracking-eyebrow text-muted-foreground uppercase">
                        ...
                        >
                          <span className="flex items-center gap-2 text-sm font-medium">
                            {hasIcon(skill.technology.icon) ? (
                              ...
                              <span
                                className="inline-flex size-3.5 shrink-0 items-center justify-center rounded-xs text-3xs leading-none font-bold text-white"
                                style={{
                                  background: skill.technology.color ?? "#888",
                                }}
                              >
